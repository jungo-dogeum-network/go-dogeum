...
#### Arguments
  - content type [string]: type of signed data
     ...
     - `application/clique`: [clique](https://github.com/dogeum-network/EIPs/issues/225) headers
...
#### Sign data
   Signs a chunk of structured data conformant to [EIP-712](https://github.com/dogeum-network/EIPs/blob/master/EIPS/eip-712.md) and returns the calculated signature.
