...
var (
	...
	PopcatBlockReward, _          = big.NewInt(0).SetString("50000000000000000000", 10) // 내가 만든 팝캣 하드포크 , 50코인씩 마이닝이 된다.
...
func makeDifficultyCalculator(bombDelay *big.Int) func(time uint64, parent *types.Header) *big.Int {
	...
	return func(time uint64, parent *types.Header) *big.Int {
		// https://github.com/dogeum-network/EIPs/issues/100.
		// algorithm:
		// diff = (parent_diff +
...
func calcDifficultyHomestead(time uint64, parent *types.Header) *big.Int {
	// https://github.com/dogeum-network/EIPs/blob/master/EIPS/eip-2.md
	// algorithm:
	// diff = (parent_diff +
