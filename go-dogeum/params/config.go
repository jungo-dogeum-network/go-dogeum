...
var (
	...
	MainnetChainConfig = &ChainConfig{
		...
		HomesteadBlock:                big.NewInt(0), // 0이면 genesis block부터 시작한다는 뜻임
		DAOForkBlock:                  big.NewInt(0),
		DAOForkSupport:                true,
		EIP150Block:                   big.NewInt(0),
		EIP150Hash:                    common.Hash{}, // default : common.HexToHash("0x2086799aeebeae135c246c65021c82b4e15a2c451340993aacfd2751886514f0"),
		...
		PopcatBlock:                   big.NewInt(100), // 내가 만든 팝캣 하드포크 블록 @ 하드포크 추가 @ 100번 블록에서 적용이된다.
		TerminalTotalDifficulty:       nil, // 58_750_000_000_000_000_000_000, MainnetTerminalTotalDifficulty (메인넷을 2.0으로 바꿔줌)
		TerminalTotalDifficultyPassed: false, // default true
...
type ChainConfig struct {
	...
	// EIP150 implements the Gas price changes (https://github.com/dogeum-network/EIPs/issues/150)
	...
	PopcatBlock    			*big.Int `json:"popcatBlock,omitempty"`   		  // 내가 만든 팝캣 하드포크 블록 @ 하드포크 추가 @
...
// 내가 만든 팝캣 하드포크
// IsPopcat returns whether num is either equal to the Popcat fork block or greater.
...
func (c *ChainConfig) CheckConfigForkOrder() error {
	...
	for _, cur := range []fork{
		...
		{name: "popcatBlock", block: c.PopcatBlock},// 내가 만든 팝캣 하드포크 블록 @ 하드포크 추가 @
